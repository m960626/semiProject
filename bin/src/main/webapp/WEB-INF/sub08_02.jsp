    ...
    <div class="wrap" id="app">
        ...
        <form action="">
            <div class="login__body">
                <div class="form_row">
                    <label for="id" class="lbl medium">아이디</label>
                    <input type="text" v-model="info.id" id="id" class="int" placeholder="아이디">
                </div>
                <div class="form_row">
				...
				<a href="javascript:;" class="btn_form type3" id="btn_sumit" @click="fnJoin">비밀번호 찾기</a>                
            </div><!-- //login__body -->
        </form>
    </div>
</div> 
...
var app = new Vue({ 
    ...
    , methods: {
    		...
    		$.ajax({
                ...
                success : function(data) {
                	if(data.result == "success"){
                		alert("정보가 일치합니다. 비밀번호변경 페이지로 이동합니다.");
                		console.log(nparmap);
		...
		fnView : function(){
			var self = this;
			self.pageChange("./newpw.do", {id : self.info.id});
		}
    }   
    , created: function () {
