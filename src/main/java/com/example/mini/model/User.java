...
public class User {
	...
	public void setcAge1(int cAge1) {
		this.cAge1 = cAge1;
	}
	public int getcAge2() {
		return cAge2;
	}
	public void setcAge2(int cAge2) {
		this.cAge2 = cAge2;
	}
	...
	public void setjStat(int jStat) {
		this.jStat = jStat;
	}
	...
	public void setMassi(int massi) {
		this.massi = massi;
	}
	...
	public int getMrCard() {
		return mrCard;
	}
	public void setMrCard(int mrCard) {
		this.mrCard = mrCard;
	}
	public int getmCnt() {
		return mCnt;
